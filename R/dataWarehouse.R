...
#'
#' Contains a template to document a data warehouse project.
#' from
#'
#' Cover from:
...
#' \dontrun{
#' library(rmarkdown)
#' draft("DW_Doc.Rmd", template = "dataWarehouse", package = "DMtemplates")
#' }
#'@importFrom bookdown pdf_document2
#'
#'@export
dataWarehouse <- function(toc = TRUE,
                      year,
                      publisher="PUBLISHER",
                      preamble,
                      fancyHeader,
  ...
  templateLatex <- system.file( "rmarkdown/templates/dataWarehouse/resources/template.tex",package = "DMtemplates",mustWork = TRUE)
